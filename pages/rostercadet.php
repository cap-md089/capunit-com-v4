<?php
	...
	class Output {
		public static function doGet ($e, $c, $l, $m, $a) {
			...
			//Page Title
			$pdf->Cell(0,.3,"Cadet Attendance Log",0,1,"C");
			//Set text font
			...
			$pdf->Cell($wSignature,$cellHeight,"Signature",$border,0,"C",$fillState);
			$pdf->Cell($wFlight,$cellHeight,"Flight",$border,1,"L",$fillState);
