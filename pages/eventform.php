        ...
        public static function doPost ($eventdata, $cookie, $loggedin, $member, $account) {
			...
			if ($eventdata['form-data']['function'] == 'create') {
				...
				$event = Event::Create(array (
					...
					'CAPPOC1ReceiveEventUpdates' => $eventdata['form-data']['CAPPOC1EUpdates'],
					'CAPPOC1ReceiveSignUpUpdates' => $eventdata['form-data']['CAPPOC1SUpdates'],
					...
					'CAPPOC2ReceiveEventUpdates' => $eventdata['form-data']['CAPPOC2EUpdates'],
					'CAPPOC2ReceiveSignUpUpdates' => $eventdata['form-data']['CAPPOC2SUpdates'],
					...
					'ExtPOCReceiveEventUpdates' => $eventdata['form-data']['ExtPOCEUpdates'],
					'PartTime' => true,
