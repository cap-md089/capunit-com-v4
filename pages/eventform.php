        ...
        public static function doGet ($eventdata, $cookie, $loggedin, $member, $account) {
            ...
            if (!!$event) {
				...
				$form->addField('', '(* Indicates Required Field)', 'textread')
					...
					->addField ('CAPPOC1EUpdates', 'Send Update Emails', 'checkbox', 'capPOCEUpdates1', Null, '1')
					->addField ('CAPPOC1SUpdates', 'Send SignUp Emails', 'checkbox', 'capPOCEUpdates1', Null, '1')
					...
					->addField ('CAPPOC2EUpdates', 'Send Update Emails', 'checkbox', 'capPOCEUpdates2', Null, '1')
					->addField ('CAPPOC2SUpdates', 'Send SignUp Emails', 'checkbox', 'capPOCEUpdates2', Null, '1')
					...
					->addField ('ExtPOCEUpdates', 'Send Update Emails', 'checkbox', 'ExtPOCEUpdates', Null, '1')
					->addField ('', 'Administrative Information', 'label')
